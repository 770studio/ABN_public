    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-6 col-8 align-self-center">
                <h3 class="text-themecolor mb-0 mt-0">Добавить субагента</h3>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        {!! Form::open(['route' => ['subagent.store'],'method'=>'post']) !!}
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group{{ $errors->has('sub_contract_number') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text"  id="sub_contract_number" class="form-control-line form-control" name="sub_contract_number" value="{{old('sub_contract_number')}}" autocomplete="off">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group{{ $errors->has('sub_contract_date') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="date"  id="sub_contract_date" class="form-control-line form-control" name="sub_contract_date" value="{{old('sub_contract_date')}}" autocomplete="off">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group{{ $errors->has('head_name') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text"  id="head_name" class="form-control-line form-control" name="head_name" value="{{old('head_name')}}" autocomplete="off">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group{{ $errors->has('head_name_2') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text"  id="head_name_2" class="form-control-line form-control" name="head_name_2" value="{{old('head_name_2')}}" autocomplete="off">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group{{ $errors->has('base_of_rules') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text"  id="base_of_rules" class="form-control-line form-control" name="base_of_rules" value="{{old('base_of_rules')}}" autocomplete="off">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group{{ $errors->has('ogrn') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text"  id="ogrn" class="form-control-line form-control" name="ogrn" value="{{old('ogrn')}}" autocomplete="off">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group{{ $errors->has('inn') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text"  id="inn" class="form-control-line form-control" name="inn" value="{{old('inn')}}" autocomplete="off">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group{{ $errors->has('kpp') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text"  id="kpp" class="form-control-line form-control" name="kpp" value="{{old('kpp')}}" autocomplete="off">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group{{ $errors->has('bank_name') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text"  id="bank_name" class="form-control-line form-control" name="bank_name" value="{{old('bank_name')}}" autocomplete="off">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group{{ $errors->has('bik') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text"  id="bik" class="form-control-line form-control" name="bik" value="{{old('bik')}}" autocomplete="off">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group{{ $errors->has('rs') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text"  id="rs" class="form-control-line form-control" name="rs" value="{{old('rs')}}" autocomplete="off">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group{{ $errors->has('ks') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text"  id="ks" class="form-control-line form-control" name="ks" value="{{old('ks')}}" autocomplete="off">
