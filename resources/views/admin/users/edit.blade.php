    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-6 col-8 align-self-center">
                <h3 class="text-themecolor mb-0 mt-0">Редактировать пользователя</h3>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text"  id="name" class="form-control-line form-control" name="name" value="{{$user->name}}" autocomplete="off">
                                ...
                                <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text"  id="email" class="form-control-line form-control" name="email" value="{{$user->email}}" autocomplete="off">
