    ...
    <div class="login-register" >
        <div class="login-box card">
            <div class="card-body">
                ...
                @endif
                    <form method="POST" action="{{ route('password.update') }}" class="form-horizontal form-material">
                        ...
                        <div class="form-group">
                                ...
                                <input placeholder="Новый пароль" id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
                        ...
                        <div class="form-group">
                                ...
                                <input placeholder="Новый пароль еще раз" id="password-confirm" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password">
                ...
                <a href="{{route('welcome')}}" class="d-block btn-link w-100 text-center mt-3 text-dark">венуться к входу</a>
            </div>
        </div>
    </div>
